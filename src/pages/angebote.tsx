    ...
    <div className="grid gap-10">
      ...
      <div className="grid gap-16">
        ...
        >
          ...
          <p>
            Kleinanlässe sind für uns Veranstaltungen mit einer Besucherzahl von
            bis zu 2000 Personen. Es ist nicht notwendig, ein gleich grosses
            Sicherheitsmanagement zu erstellen wie für Grossanlässe. In einem
            persönlichen Gespräch klären wir mit ihnen das Notwendige, damit Sie
            auch mit kleinem Budget eine maximale Sicherheitsleistung im Namen
            ihrer Veranstaltung bieten können. An Klein- und Grossanlässen
            umfasst das Einsatzgebiet der NSW Security - Services folgende
            Gebiete: - Zutritts- und Eingangskontrollen - VIP- und
            Backstagesicherheit - Personenschutz - Innendienst - Bühnengraben -
            Objektschutz{" "}
          </p>
        </IconCardBig>
        <IconCardBig
